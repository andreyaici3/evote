<x-be-layout active="pemilih" title="Data Pemilih" header="Pemilih" subheader="Halaman kelola Data Pemilih">
            ...
            <div class="card">
                <div class="card-body d-flex justify-content-between align-items-center">
                    <div class="card-title mb-0">
                        <h4 class="mb-0">DAFTAR PEMILIH</h4>
                    </div>
                    <div class="card-action">
                        <a href="{{ route('admin') }}" class="btn btn-primary" role="button">Kembali</a>
                        <a href="{{ route('admin.pemilih.create') }}" class="btn btn-primary" role="button">Tambah
                            Pemilih</a>
                    </div>
                </div>
            </div>
                            ...
                            <tbody>
                                ...
                                @foreach ($data['list'] as $item)
                                    <tr>
                                        ...
                                        <td>{{ \Carbon\Carbon::parse($item->tanggal_lahir)->diff(\Carbon\Carbon::now())->format('%y Tahun') }}
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('admin.pemilih.edit', $item->nik) }}"
                                            ...
                                            <button class="btn btn-icon btn-primary modal-hapus" data-bs-toggle="modal"
                                                data-bs-target="#exampleModal" data-nik="{{ $item->nik }}">
                                                <span class="btn-inner">
                                                    <svg class="icon-32" width="32" viewBox="0 0 24 24"
                                                        fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <path fill-rule="evenodd" clip-rule="evenodd"
...
<script>
    $(function() {
        $(".modal-hapus").click(function() {
            ...
            var url = '{{ route("admin.pemilih.hapus", ":b_id") }}';
