<x-be-layout active="paslon" title="Data Paslon" header="Paslon" subheader="Halaman kelola Data Paslon">
            ...
            <div class="card">
                <div class="card-body d-flex justify-content-between align-items-center">
                    <div class="card-title mb-0">
                        <h4 class="mb-0">DAFTAR PASANGAN CALON</h4>
                    </div>
                    <div class="card-action">
                        <a href="{{ route('admin') }}" class="btn btn-primary" role="button">Kembali</a> <a href="{{ route('admin.paslon.tambah') }}" class="btn btn-success" role="button">Tambah Paslon</a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="table-responsive">
                        <table id="datatable" class="table table-striped" data-toggle="data-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{ $nomor++ }}</td>
                                    <td>Nomor Urut {{ $item->nomor_urut }}</td>
                                    <td>{{ $item->nama_paslon }}</td>
                                    <td>
                                        <img width="50%" src="{{ asset('assets/images/' . $item->foto) }}" alt="">
                                    </td>
                                    <td>
                                        ...
                                        <a href="{{ route('admin.paslon.edit', $item->id) }}"
...
<script>
    $(function() {
        $(".modal-hapus").click(function() {
            ...
            var url = '{{ route("admin.paslon.hapus", ":b_id") }}';
