        ...
        <section class="login-content">
            <div class="row m-0 align-items-center bg-white vh-100">
                            ...
                            <div class="card card-transparent shadow-none d-flex justify-content-center mb-0 auth-card">
                                <div class="card-body">
                                    <a href="../../dashboard/index.html"
                                        ...
                                        <h4 class="logo-title ms-3">PILKADA</h4>
                                    </a>
                                    <h2 class="mb-2 text-center">Login</h2>
                                    <p class="text-center">Sebagai Admin / Panitia</p>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="form-group">
                                                    ...
                                                    <input value="{{ old('email') }}" type="email" name="email" class="form-control @error('email') is-invalid @endif"
                ...
                <div class="col-md-6 d-md-block d-none bg-primary p-0 mt-n1 vh-100 overflow-hidden">
                    <img src="{{ asset('assets-be/images/auth/01.png') }}"
